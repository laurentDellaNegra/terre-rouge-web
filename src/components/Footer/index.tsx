...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/Terre-rouge-110743050844652/',
      icon: (props: any) => (
    ...
    {
      name: 'Linkedin',
      href: 'https://www.linkedin.com/in/terre-rouge-4728571bb/',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@terrerougeepices',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 3333 3333" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
            &copy; 2020 Terre Rouge. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
